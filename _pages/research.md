...
<p style="font-size:14px"> News media’s reporting of episodic information biases citizens' beliefs about the world, because citizens infer based on local individual instances. Could a changed news coverage correct citizen misperceptions? We answer this question through a field-experiment addressing the main source of episodic information on burglaries in Denmark: local news media. We partnered up with a media conglomerate, publishing 63 news papers across 334 cities. For one week, in a random subset of zip codes, we place adds showing the factual decline in burglary rates in every reader's respective municipality (totaling 1m showings). The size of our add buy guarantees that every visitor is exposed to our information. The add is placed around every crime story as well as on every news sites’ home page and is posted by a non-for-profit crime prevention collaboration.  In the week preceding our intervention and five weeks after, we measure outcomes in all cities through an unrelated add quizzing readers on their municipality, posted by a well-respected survey company. As individual readers see the quiz-add on a randomly selected day, we are able to study the durability of effects over time. </p>
